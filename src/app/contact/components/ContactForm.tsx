...
export const ContactForm = () => {
  ...
  return (
        ...
        <form onSubmit={handleSubmit}>
            <div className=" rounded-2xl  bg-opacity-65 shadow bg-gray-900  p-6">
                ...
                <button 
                  ...
                  className="w-full rounded-lg bg-gray-700 py-2.5 text-sm text-white transition duration-300 hover:bg-gray-500 font-semibold"
                > 
                  Enviar
                </button>
                {
